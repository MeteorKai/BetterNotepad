...
const en: Dict = {
  ...
  "about.tabUpdateAvailable": "An update is available",
  ...
  "about.idleHint":
    "BetterNotepad checks for updates on its own a few seconds after launch, and only says something when a new version exists. Every update is signed, and the signature is verified before anything is installed.",
  "about.contacting": "Contacting GitHub…",
  "about.latest": "You are on the latest version.",
  "about.latestWithVersion": "You are on the latest version ({version}).",
  "about.available": "Version {version} is available{date} — you are on {current}.",
  "about.releasedOn": " (released {date})",
  "about.install": "Download and install",
  "about.installNote": "Unsaved work is restored on restart.",
  "about.downloading": "Downloading update…",
  "about.downloadingPct": "Downloading update… {pct}%",
  "about.installing": "Installing — BetterNotepad will restart automatically.",
  "about.failed": "Update check failed: {error}",
  "about.releasesHint": "Updates are published on the project's GitHub releases page.",
  "about.viewReleases": "View all releases",
...
const zh: Dict = {
  ...
  "resize.title": "拖动调整宽度",
  "about.tabUpdateAvailable": "有新版本可用",
  ...
  "about.checking": "检查中…",
  "about.idleHint":
    "BetterNotepad 会在启动几秒后自动检查更新，只有出现新版本时才会提示。每个更新包都带签名，校验不通过不会被安装。",
  "about.contacting": "正在连接 GitHub…",
  "about.latest": "已是最新版本。",
  "about.latestWithVersion": "已是最新版本（{version}）。",
  "about.available": "发现新版本 {version}{date} —— 当前版本 {current}。",
  "about.releasedOn": "（发布于 {date}）",
  "about.install": "下载并安装",
  "about.installNote": "未保存的内容会在重启后恢复。",
  "about.downloading": "正在下载更新…",
  "about.downloadingPct": "正在下载更新… {pct}%",
  "about.installing": "正在安装 —— BetterNotepad 稍后会自动重启。",
  "about.failed": "检查更新失败：{error}",
  "about.releasesHint": "更新发布在项目的 GitHub Releases 页面。",
  "about.viewReleases": "查看所有版本",
